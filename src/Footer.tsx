        ...
        <footer className="bg-gray-50 dark:bg-gray-800">
            <div className="max-w-screen-xl p-4 py-6 mx-auto lg:py-16 md:p-8 lg:p-10">
                ...
                <div className="text-center">
                    ...
                    <span className="block text-sm text-center text-gray-500 dark:text-gray-400">© 2023 Find My School™ | All Rights Reserved <br/> Built with <a href="https://flowbite.com" className="text-purple-600 hover:underline dark:text-purple-500">Vite + React TS</a> and <a href="https://tailwindcss.com" className="text-purple-600 hover:underline dark:text-purple-500">Tailwind CSS</a>.
                    </span>
